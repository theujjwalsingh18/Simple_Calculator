...
public class CalculatorSimple {
    ...
    public CalculatorSimple() {
        ...
        head = new JLabel("<html><b>Calculator Made by </b></html>");
        head.setBounds(50,15,350,35);
        window.add(head);
        tail = new JLabel("@theujjwalsingh18");
        tail.setBounds(190,15,350,35);
        tail.setForeground(Color.blue);
        window.add(tail);
